...
public:
	ILI9341_due_gText(Adafruit_ILI9341_STM *ili); // default - uses the entire display
	ILI9341_due_gText(Adafruit_ILI9341_STM *ili, int16_t x1, int16_t y1, int16_t x2, int16_t y2); //, textMode mode=DEFAULT_SCROLLDIR);

	ILI9341_due_gText(Adafruit_ILI9341_STM *ili, int16_t x1, int16_t y1, int16_t columns, int16_t rows, gTextFont font); //, textMode mode=DEFAULT_SCROLLDIR);
